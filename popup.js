...
/* function generatePossibilities(final_word, yellow_letters, black_letters) {

    possibilities = [];

    // read the known words from the file
    let knownWords = [
      "which",
      "there",
      "their",
...
*/
// console.log(generatePossibilities(['a',undefined, undefined, undefined,undefined], {'h':[0], 'e': [1,4]}, "ppl"));


function getPossibilitiesRunner() {
  // get all of game-rows
  let app = document.getElementsByTagName("game-app")[0].shadowRoot
  ...
  for (let i = 0; i < gameRows.length; i++) {
    ...
    // get the game-tiles
    let gameTiles = gameRow.shadowRoot.querySelectorAll("game-tile");
    for (let j = 0; j < gameTiles.length; j++) {
      let gameTile = gameTiles[j];
      let letter = gameTile.getAttribute("letter");
      let evaluation = gameTile.getAttribute("evaluation");
...
// get the button
let getPossibilities = document.getElementById("get_possobilities_btn");

// add event listener to the button
getPossibilities.addEventListener("click", async () => {
